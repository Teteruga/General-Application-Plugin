 ...
 */
namespace GeneralApplicationUtilities\Shell\Task;
...
class TemplateTask extends BakeTask
{
    ...
    public function initialize()
    {
        ...
        $this->language = $bake_language;

        try{
            Configure::load('GeneralApplicationUtilities.plugin_config', 'default');
    
            $bake_language_scaffoldActions = Configure::read('languageTemplateActions.'.$bake_language);
            $bake_language_noTemplateActions = Configure::read('noTemplateActions.'.$bake_language);

            $this->scaffoldActions = $bake_language_scaffoldActions;
            $this->noTemplateActions = $bake_language_noTemplateActions;
        }
        catch(\Exception $e){
            
            $this->scaffoldActions = ['index', 'view', 'add', 'edit', 'delete', 'listar_by_association_ajax'];
            $this->noTemplateActions = ['delete', 'listar_by_association_ajax'];
    ...
    public function bake($action, $content = '')
    {
        ...
        // $filename = $path . Inflector::underscore($translation[$action]). '.ctp';
    ...
    public function getContent($action, $vars = null)
    {
        ...
        return $this->BakeTemplate->generate("Template/$this->language/$action");
    }
    ...
    public function getOptionParser()
    {
        ...
        $parser->setDescription(
            'Bake views for a controller based on the language choosen in the config file, using built-in or custom templates. '
